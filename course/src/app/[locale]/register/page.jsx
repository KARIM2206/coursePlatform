...
//       setemail("");
//      setrole('')
//       // router.push(`/verify-email?next=${next}`);
//     } catch (error) {
...
//       >
//         <div className="w-full max-w-md bg-white shadow-xl rounded-2xl padding-x 
//         padding-y p-10 space-y-8 border border-primary-600">
...
//               <Link href={`/${localeNavigate}/login`} className="text-primary-600 hover:underline font-semibold">
//                 {translate.login}
//               </Link>
//             </p>
//           </form>
...
console.log(dict,locale);
  ...
  return <Signup dict={dict.signup} locale={locale} />;
}
